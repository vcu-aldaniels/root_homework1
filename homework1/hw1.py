...
def return_lowercased_string(input_string):
    ...
    return_value = return_lowercased_string.lower(input_string)
    return return_value
...
def return_without_starting_ending_whitespace(input_string):
    ...
    return_value = return_without_starting_ending_whitespace.strip(input_string)
    return return_value
